import 'package:diabe_trek/screens/DFU/home_screen.dart';
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "Physical Activity",
                              style:
                                  Styles.headlineStyle1.copyWith(fontSize: 15),
                            ),
                            Text(
                              "create your own physical",
                              style:
                                  Styles.headlineStyle4.copyWith(fontSize: 10),
                            ),
                            Text(
                              "Activity Routine",
                              style:
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const dpn_start()));
                      },
                      child: Container(
                        height: 145,
                        width: 150,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            "Meal Planning",
                            style: Styles.headlineStyle1.copyWith(fontSize: 15),
                          ),
                          Text(
                            "Plan a healthy diet",
